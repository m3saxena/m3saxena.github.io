...
$address = "inquiries@madhulikasaxena.com";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<div class='notification success clearfix'><p>Thank you <strong>$name</strong>, your message has been submitted.</p></div>";
	echo "</div>";
	echo "</fieldset>";
